					...
					<form:form class="myclass" method="POST"
						...
						<div class="md-form">
							<i class="fa fa-user prefix white-text"></i> <label
								for="orangeForm-name2">First Name</label>
							<form:input type="text" id="orangeForm-name2"
								class="form-control" path="firstName" required="true" />

						</div>
						<div class="md-form">
							<i class="fa fa-user prefix white-text"></i> <label
								for="orangeForm-name2">Last Name</label>
							<form:input type="text" id="orangeForm-name2"
								class="form-control" path="lastName" required="true" />
						...
						<div class="md-form">
							...
							<form:input type="mobile" id="orangeForm-mobile2"
								class="form-control" path="mobile" required="true"
						...
						<div class="md-form">
							...
							<form:input type="text" id="orangeForm-name2"
								class="form-control" path="address" required="true" />

						</div>
						<div class="md-form">
							<i class="fa fa-lock prefix white-text"></i> <label
								for="orangeForm-name2">Pin code</label>
						...
						<c:choose>
							<c:when test="${student.id!=null}">
								<div class="md-form">
									...
									<i class="fa fa-text prefix white-text"></i>
									<button style="background-color: green" type="submit" id="button1id" name="button1id"
										class="btn btn-info btn-sm">Update</button>
									<button onclick="/viewStudents" style="background-color: grey" type="submit" id="button2id" name="button2id"
						...
						<div class="md-form">
							...
							<button style="background-color: green" type="submit" id="button1id" name="button1id"
								class="btn btn-info btn-sm">Register</button>
								
							<button style="background-color: grey" type="reset" id="button2id" name="button2id"
