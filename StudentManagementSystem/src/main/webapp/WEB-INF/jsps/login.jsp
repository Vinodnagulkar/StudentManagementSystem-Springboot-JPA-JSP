		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<div class="avatar">
					...
					<%-- <img src="<c:url value='${pageContext.request.contextPath}/images/avatar.png' />"  alt="exit" /> --%>
				</div>
			...
			<div class="modal-footer">
				<p>
					New User? <a style="color: grey" href="/registerOpener">Register
						Here</a>
				</p>
				<a style="color: grey" href="/ForgetPassword">Forgot Password?</a>
			</div>
		</div>
	</div>
